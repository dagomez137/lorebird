...
pub use config::{
    AppConfig, ContactGroup, DEFAULT_READING_PANE_COLUMNS, DEFAULT_WORKING_SET_LIMIT, GlobalHooks,
    LoadedConfig, ProfileData, ProfileHooks, ResolvedProfile, UserInfo, ViewConfig,
};
